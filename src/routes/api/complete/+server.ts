...
export const GET: RequestHandler = async ({ url }) => {
    ...
    if (url.searchParams.get('eventId') && url.searchParams.get('teamState') && url.searchParams.get('teamId') && url.searchParams.get('teamId2') && url.searchParams.get('teamScoreId')) {
